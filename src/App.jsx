  ...
  return (
    <div className="container">
      <div className="hero">
        ...
        <ul className="nav">
          <li className="nav-item"><a className="nav-link" href="https://firebasestorage.googleapis.com/v0/b/aboutme-ashutosh.appspot.com/o/aboutme-ashutosh%2Fashutosh_resume.pdf?alt=media&token=c2983ea0-9ffa-4ede-82c7-01b55f447fad" target="_blank" rel="noreferrer"><i className="fa fa-file-pdf-o"></i></a></li>
